      ...
      {loading ? (
        <div className="bg-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 animate-pulse">
            <div className="bg-white rounded-2xl shadow-md overflow-hidden border border-gray-200 max-w-3xl mx-auto">
              <div className="w-full h-64 sm:h-80 md:h-96 bg-gray-300"></div>
              <div className="p-5 sm:p-6">
                <div className="h-10 bg-gray-300 rounded w-52 mb-5"></div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-5 mb-6">
                  ...
                  <div className="h-12 w-full sm:w-40 bg-gray-300 rounded-xl"></div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="bg-white rounded-2xl shadow-md overflow-hidden border border-gray-200 max-w-3xl mx-auto">
              ...
              <div className="p-5 sm:p-6">
                ...
                <p className="text-gray-600 text-base sm:text-lg mb-7 leading-relaxed">
                ...
                <div className="flex flex-col sm:flex-row justify-between sm:items-end items-start gap-5 mb-7">
                  ...
                  <Button
                    ...
                    className="bg-blue-600 hover:bg-blue-700 text-white w-full sm:w-auto min-w-[160px] px-8 py-3 rounded-xl shadow-sm transition-colors duration-200 text-center text-lg sm:text-base"
                  >
                    {itemAdded}
                  </Button>
                </div>
                ...
                {userType === "admin" && (
                  <div className="flex flex-col sm:flex-row gap-4 pt-5 border-t border-gray-200">
                    <Button
                      onClick={handleEdit}
