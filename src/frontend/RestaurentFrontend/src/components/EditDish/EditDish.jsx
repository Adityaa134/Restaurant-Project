...
function EditDish() {
  ...
  useEffect(() => {
    try {
      ...
      logger.error(
        "Edit Dish Component :: Error in fetching dish details :: ",
        error,
      );
      setLoading(false);
    }
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      logger.error("Edit Dish Component :: Error in updating dish  :: ", error);
    } finally {
      ...
      {loading ? (
        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-100 px-4">
          <div className="w-full max-w-md bg-white rounded-lg shadow-lg p-6">
                ...
                <Input
                  ...
                  {...register("dishName", {
                    ...
                    validate: {
                      matchPattern: (value) =>
                        /^[a-zA-Z\s\-'.,&()]+$/.test(value) ||
                        "Dish Name should only contains characters",
                    },
                  })}
                />
                {formErrors.dishName && (
                ...
                <Input
                  ...
                  {...register("price", {
                    ...
                    validate: {
                      matchPattern: (value) =>
                        /^\d+(\.\d{1,2})?$/.test(value) ||
                        "Price should only conatins digits.",
                    },
                  })}
                />
                {formErrors.price && (
              ...
              <div>
                ...
                <div>
                  <img
                    src={dishImage}
                    alt="Current dish"
                    className="w-52 h-40 object-cover rounded-lg border shadow-sm"
                  />
                </div>
              </div>
            ...
            {errors && (
              <p className="text-red-600 mt-8 text-center">{errors}</p>
            )}
          </div>
        </div>
      )}
